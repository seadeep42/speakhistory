...
const SessionsPage = () => {
    return (
        <SessionDetails
            sessionInfo={SESSIONS.hyder}
            synopsis={
                <>
                    He never called himself a Sultan, but was undoubtedly the Sultan. He was keen to begin a dynasty but the grooming of his son was still incomplete. He did not expect to die, but death didn't bother about his preference. And when he died, it took effort to contain the chaos.
                </>
            }
            next={SESSIONS.yadavagiri}
        >
            <p>
                ...
                Thus, odds were against Tipu Sultan and his ascent to throne was fraught with deep difficulties.  But Hyder Ali seems to have been determined that Tipu should inherit the throne, as he is believed to have asked from his senior officers their loyalty to Tipu, exactly the way they had given it to him.  <br /><br />
                As a result, the news of the death of Hyder Ali was kept a secret until the time Tipu Sultan rushed back from his Malabar campaign.  The casket bearing the body of Hyder Ali was secretly moved to Srirangapatna - the capital, in guise of treasure recovered in the war.  The British at first did not believe that Hyder was dead when they heard the news and General Stuart in command of the army could not mobilise forces to attack Mysore immediately.  Tipu Sultan swiftly neutralised a conspiracy to coronate his younger brother, by arresting and killing the military men responsible for the idea.  He kept at bay the brewing conspiracy of the erstwhile rulers of Mysore by restricting them severely.  And he placated the young commander of Bednur in the borderlands with Marathas, so that his conspiratorial plans of teaming up with the British and other adversaries could not be realised.<br /><br />
                The short period of time between the death of his father and his consolidation of power between 1782 and 1783 was a dramatic one, filled with conspiracies, treacheries, greed, power politics, a kingdom's vulnerability and a deep fear of the unknown.  The young Sultan, with the help of loyal officers of the court, displayed immense courage and composure in ascending to the throne, which he successfully held for the next 16 years.
            </p>
        </SessionDetails>
    );
};
