...
const SessionsPage = () => {
    return (
        <SessionDetails
            sessionInfo={SESSIONS.persia}
            synopsis={
                <>
                    Persian civilization has been one of the most unique organisations of human communities in history. Geographically located at the cross roads of other civilizations from Indus valley, Mesopotamia, Greece, Arabia and Central Asia, the Persian culture influenced humankind for thousands of years. While a certain peace reigned in Persia in art, music, poetry, architecture and such, immense violence too marked its time.
                </>
            }
            prev={SESSIONS.bighunger}
            next={SESSIONS.jordan}
        >
            <p>
